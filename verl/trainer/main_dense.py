...
# import debugpy
# debugpy.listen(('localhost', 5678)) # 先运行程序再运行launch文件
# print('Waiting for debugger attach')
# debugpy.wait_for_client() # 阻塞进程等待远程
...
def main():
    ...
    if not ray.is_initialized():
        ...
        ray.init(runtime_env={"env_vars": {"TOKENIZERS_PARALLELISM": "true", "NCCL_DEBUG": "WARN"}},num_cpus=14)
